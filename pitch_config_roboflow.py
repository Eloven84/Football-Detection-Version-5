...
PITCH_KEYPOINTS = {
    ...
    # Tambah 3 keypoint baru:
    27: m_to_px(105, 54.16),          # right big rect bottom-right (area kanan bawah)
    30: m_to_px(0,   34),             # left sideline mid
    31: m_to_px(52.5 - 9.15, 34),    # center_circle_left
}